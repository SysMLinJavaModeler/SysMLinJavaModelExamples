...
public class CableSW1toNE8 extends Cable
{
	...
	{
		eastPoint = ((CableStayedBridge)contextBlock.get()).deck.suspensionPointsSouth.get(1);
		westPoint = ((CableStayedBridge)contextBlock.get()).deck.suspensionPointsNorth.get(8);
		super.createValues();
