...
public class TargetServiceControl extends ServiceControl
{
	public TargetServiceControl(ServiceStatesEnum state, InstantMilliseconds time)
	{
		super(state, time);
	}
	...
	{
		return String.format("TargetServiceControl [state=%s, time=%s]", state, time);
	}
}
